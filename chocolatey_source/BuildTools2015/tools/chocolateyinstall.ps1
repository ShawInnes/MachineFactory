...
$url = 'C:\Install\BuildTools_2015_Full.exe' # download url
...
Install-ChocolateyPath 'C:\Program Files (x86)\MSBuild\14.0\Bin' 'Machine' # Machine will assert administrative rights
